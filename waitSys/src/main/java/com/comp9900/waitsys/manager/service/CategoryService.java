...
public interface CategoryService extends IService<Category> {
    ...
    */
    ...
    /**
    * @Description: change the order of categories
    * @Param: [categoryIdList, orderNumList]
    * @return: boolean
    * @Author: Weizhe Pan
    * @Date: 2023/6/27
    */
    boolean changeCategoryOrder(List<Integer> categoryIdList, List<Integer> orderNumList);
}
